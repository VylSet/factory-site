...
<path d="M 0 7.5 L 0 12.5 L 50 12.5 L 50 7.5 Z M 0 22.5 L 0 27.5 L 50 27.5 L 50 22.5 Z M 0 37.5 L 0 42.5 L 50 42.5 L 50 37.5 Z"></path>
      ...
      <div className="relative h-screen">
        ...
        <div className="relative flex h-full flex-col items-center justify-center px-4 text-center">
          ...
          <p className="mb-8 max-w-[600px] text-xl text-gray-300 md:text-xl lg:text-2xl leading-tight pt-5">
            Experience premium grooming services in a unique atmosphere where faith meets style
          </p>
          <Button
            className="bg-[#445362] px-8 py-6 text-lg font-semibold transition-all hover:bg-primary/90 hover:shadow-lg -mt-2"
            size="lg"
          >
            Book Now
          </Button>
